...
<body>
	<header id="cs"
		...
		<div class="col-lg-12">
			<nav id="topMenu">
				<ul>
					<li><a class="menuLink" href="/customerService/cs"><spring:message code="faq.cs" /></a></li>
					<li><a class="menuLink" href="/customerService/faq"><spring:message code="faq.faq" /></a></li>
	...
	<div class="container">
		<div class="row">
			<div class="accordion">
				...
				<div>
					<p>클릭스냅에서 활동하시는 포토그래퍼회원마다 등록한 비용이 다릅니다. 촬영이 필요한 지역과 예산에 따라 검색하신
				...
				<div>
					<p>클릭스냅에서는 유사한 클레임이 발생하지 않도록 노력하고 있으며, 아래와 유사한 클레임이 발생하는 경우
						...
						클랙스냅의 중재역할 및 중재 프로세스 촬영예약의 확정이후 별도 고지 없이 포토그래퍼회원(촬영작가)에게 연락이 닿지 않을시
						...
						후 답변을 한 포토그래퍼회원들에 대하여 최대 5명까지 연락처 전달을 클릭스냅 고객지원팀에 요청할 수 있습니다. 이 외
						클릭스냅 고객지원팀에서 포토그래퍼의 직접섭외 및 제공의무는 없으며 주장 할 수 없습니다.</p>
				</div>
			</div>
