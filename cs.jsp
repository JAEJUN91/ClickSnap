...
<body>
	...
	<header id="cs" style="background-image: url(../../../resources/images/csimg.jpg)">
		<div class="container">
	 ...
	 <div class="row">
		<div class="col-lg-12">
			<nav id="topMenu">
				<ul>
					<li><a class="menuLink" href="/customerService/cs"><spring:message code="cs.cs" /></a></li>
					<li><a class="menuLink" href="/customerService/faq"><spring:message code="cs.faq" /></a></li>
				</ul>
			</nav>
		</div>
	</div>
	 ...
	 <div class="container">
		<div class="row">
			<div class="accordion">
				...
				<div>
					<p>안녕하세요? 커뮤니티 매니저입니다. "스튜디오/사진관 방문형" 촬영상품을 판매할 수 있는 새로운
						기능이 마련되었으며, 내부작가님에게만 우선공개합니다. 7월 말까지 내부작가님의 사전등록시 추천으로 우선 선정될
						예정입니다. 스튜디오/사진관 방문형 촬영이란? 기존 까지는 대부분 "출장" 방식의 촬영이었습니다. 이번 개편으로 작가님이
...
<div
  ...
  data-channel-public-id="_Upxcxjs"
  data-title="consult"
  data-size="small"
  data-color="yellow"
  data-shape="pc"
