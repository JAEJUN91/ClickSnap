	...
	<div class="container">
		<div class="jumbotron">
			<div class='row'>
				...
				<div class="col-lg-10">
					<span class="badge bg-secondary">badge1</span> <span
						class="badge bg-success">badge2</span> <span
						class="badge bg-danger">badge3</span><br>
					<h2>artist_id</h2>

					<span class='star-rating'> <span style="width: 50%"></span>
					</span> <span class="badge bg-primary">2.5/5</span> | <span
						class="badge bg-warning">n건의 평가</span>

					<button type="button" class="btn btn-info">아티스트에게 문의하기</button>
				</div>
			</div>
		</div>
		...
		<div class="row">
			...
			<div class="col-md-5" style="border: 1px groove;">
				<div>
					...
					<br>
					<p>
						총 작업수<span style="float: right;">10건</span>
					</p>
					<p>
						고객만족도<span style="float: right;">50%</span>
					</p>
					<p>
						페널티횟수<span style="float: right;">1건</span>
					</p>
					<br>
				</div>
				<div>
					...
					<br>
					<p>
						등급<span style="float: right;">3단계</span>
					</p>
					<p>
						컨셉<span style="float: right;">웨딩, 가족</span>
					</p>
					<p>
						활동지역<span style="float: right;">서울, 경기</span>
					</p>
					<br>
				</div>
				<div>
