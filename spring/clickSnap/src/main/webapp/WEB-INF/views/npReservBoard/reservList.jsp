...
$(document).ready(function(){
	...
	$("#regBtn").on("click",function(){
		self.location ="/npReservBoard/register"; // 글쓰기 버튼 글 작성폼으로 보내주는 기능
	});
	...
	var actionForm = $("#actionForm");
				...
				$(".move").on("click",function(e){
					...
					actionForm.attr("action","/npReservBoard/get");
					actionForm.submit();
				});
});
//document ready function
				...
				<div>
					<ul class="pagination">
						...
						<c:if test="${pageMaker.next }">
							...
							<li><button type="button" class=" btn btn-success" id="regBtn">글쓰기</button></li>
					</ul>
				
				</div>
				<!-- Pagination -->
				<form id="actionForm" action="/npReservBoard/reservList" method="get">
